...
if rope_max == lengths:
    print(rope_max * 2)
elif lengths < rope_max:
    ropes.append(rope_max - lengths)
    # print(min(ropes))
    print(rope_max - lengths)
else:
    print(sum(ropes) + rope_max)
...
На столе лежали две одинаковые верёвочки целой положительной длины. Петя разрезал одну из верёвочек на N частей,
каждая из которых имеет целую положительную длину, так что на столе стало N+1 верёвочек.
